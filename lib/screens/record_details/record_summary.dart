      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            RideRecordDetail("Elev. gained", "${formatDoubleWithTwoDecimals(rideInfo.elevGained)} m"),
            RideRecordDetail("Elev. loss", "${formatDoubleWithTwoDecimals(rideInfo.elevLoss)} m"),
