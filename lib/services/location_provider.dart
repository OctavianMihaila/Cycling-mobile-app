...
class LocationProvider with ChangeNotifier {
  ...
  ElevationProvider elevationProvider = ElevationProvider();
  ...
  double getElevationGain() {
    return elevationProvider.currentElevationGain;
  }

  double getElevationLoss() {
    return elevationProvider.currentElevationLoss;
  }
  ...
  void startListeningForLocationChanges() {
    _positionStreamSubscription = Geolocator.getPositionStream().listen(
      ...
      if (distance >= 0.5) {
        ...
        elevationProvider.fetchAndUpdateElevation(position.latitude, position.longitude);
        notifyListeners();
